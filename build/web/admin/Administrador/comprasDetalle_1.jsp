            ...
            <div class="modal-content">
                <div class="modal-body">
                    <form action="sr_ComprasDetalle_adm" method="post" enctype="multipart/form-data" class="form-group">
                        ...
                        <button name="btn_eliminar" id="btn_eliminar" value="eliminar" class="btn btn-danger btn-lg" onclick="return confirm('¿Desea eliminar este detalle de compra?')">Eliminar</button>
